  ...
  return (
    <main className="min-h-screen bg-gray-200 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
        ...
        <label className="text-base block mb-1">Organization name</label>
        <input
          className="w-full border border-slate-300 rounded px-3 py-2 text-base mb-3"
        ...
        <button onClick={doSignup} className="w-full bg-black hover:bg-gray-800 text-white rounded-lg px-3 py-2 text-base cursor-pointer">
          Sign up
        </button>
